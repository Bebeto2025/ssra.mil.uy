    ...
    case 'registrar-drone':
      return (
        <form className="tramite-form" onSubmit={handleSubmit}>
          ...
          <label>
            Uso previsto
            <select name="uso" required defaultValue="">
              <option value="" disabled>
                Seleccione...
              </option>
    ...
    case 'baja-drone':
      return (
        <form className="tramite-form" onSubmit={handleSubmit}>
          {commonFields}
          <label>
            Número de registro del drone
            <input type="text" name="registro" required placeholder="Ej: DR-2024-00123" />
          </label>
          <label>
            Motivo de baja
            <select name="motivo" required defaultValue="">
              ...
              <option value="venta">Venta / transferencia</option>
              <option value="destruccion">Destrucción / pérdida</option>
          ...
          <label>
            Detalle del motivo
            <textarea name="detalle" rows={3} required />
          </label>
          <button type="submit" className="btn btn--primary">
            Solicitar baja
          </button>
